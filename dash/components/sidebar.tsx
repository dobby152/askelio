...
const navigation = [
  ...
  { name: "Dokumenty", href: "#", icon: FileText, current: false },
  { name: "Statistiky", href: "#", icon: BarChart3, current: false },
  { name: "Uživatelé", href: "#", icon: Users, current: false },
]

const quickActions = [
  { name: "Nový dokument", href: "#", icon: FileText },
  { name: "Správa kreditů", href: "#", icon: CreditCard },
  { name: "Nastavení", href: "#", icon: Settings },
  { name: "Export dat", href: "#", icon: Download, onClick: true }, // Přidej onClick: true
  { name: "Nápověda", href: "#", icon: HelpCircle },
]
