...
import { Mail, Lock, AlertCircle, CheckCircle, Eye, EyeOff, ArrowLeft, User } from 'lucide-react'
      ...
      <div className="min-h-screen bg-white flex items-center justify-center p-4">
        <div className="max-w-md w-full">
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-8 border border-gray-200 text-center">
            ...
            <h1 className="text-3xl font-bold text-gray-900 mb-4">Registrace úspěšná!</h1>
            <p className="text-gray-600 mb-8 leading-relaxed">
              Váš účet byl úspěšně vytvořen. Zkontrolujte svůj e-mail a potvrďte registraci. Poté se můžete přihlásit a začít používat Askelio.
            </p>
            <Link
              href="/auth/login"
              className="inline-block bg-blue-600 text-white px-8 py-3 rounded-xl hover:bg-blue-700 transition-all duration-200 font-semibold shadow-lg hover:shadow-xl transform hover:scale-[1.02]"
            >
      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-8 border border-gray-200">
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-900">Začněte zdarma</h1>
            <p className="text-gray-600 mt-2">Vytvořte si účet Askelio během několika sekund</p>
          </div>
          ...
          <form onSubmit={handleRegister} className="space-y-6">
            ...
            >
              {loading ? 'Registrování...' : 'Vytvořit účet zdarma'}
            </button>
          </form>
